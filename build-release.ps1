# Baker Scale Connect — Build & Package Script
...
$PackId      = "BakerScaleConnect"
$MainExe     = "BakerScaleConnect.exe"
...
dotnet publish "$ProjectDir\BakerScaleConnect.csproj" `
    -r win-x64 `
    --self-contained true `
...
Write-Host ""
Write-Host "  BakerScaleConnect-$Version-Setup.exe  ? distribute this to users"
